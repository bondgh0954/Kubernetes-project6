...
helm install -f values/product-service-values.yaml productservice charts/microservice
helm install -f values/product-catalog-service-values.yaml productcatalog charts/microservice
